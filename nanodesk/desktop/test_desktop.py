...
def test_config_manager():
    ...
    # Test save
    test_config = {
        "agents": {"defaults": {"model": "test-model", "provider": "test-provider"}},
        "providers": {
            "test-provider": {"apiKey": "test-key-12345", "apiBase": "https://test.example.com"}
        },
        "channels": {"feishu": {"enabled": False, "appId": "", "appSecret": ""}},
